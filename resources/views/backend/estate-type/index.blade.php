...
<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ route( 'estate-type.index' ) }}">Danh mục cha</a></li>
            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td style="white-space:nowrap; text-align:right">                  
                  <a href="{{ route( 'estate-type.edit', [ 'id' => $item->id ]) }}" class="btn-sm btn btn-warning">Chỉnh sửa</a>                 
                
                  <a onclick="return callDelete('{{ $item->name }}','{{ route( 'estate-type.destroy', [ 'id' => $item->id ]) }}');" class="btn-sm btn btn-danger">Xóa</a>
