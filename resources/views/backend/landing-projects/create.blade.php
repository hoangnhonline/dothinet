...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <form role="form" method="POST" action="{{ route('landing-projects.store') }}">
    <div class="row">
      <!-- left column -->
            ...
            <div class="box-body">
              ...
              @endif                     
                ...
                <div class="form-group" style="margin-top:10px;margin-bottom:10px">  
                  ...
                  <div class="col-md-9">
                    <img id="thumbnail_logo" src="{{ old('logo_url') ? Helper::showImage(old('logo_url')) : URL::asset('backend/dist/img/img.png') }}" class="img-thumbnail" width="145" height="145">
                ...
                <div class="form-group">
                  ...
                  <?php $i = 0; ?>
                    ...
                    <li style="list-style:none">
                      ...
                      {{ old('tab') && in_array($tab->id, old('tab')) ? "checked" : "" }}
                      >
