            ...
            @if( $items->count() > 0 )
              ...
              <tr id="row-{{ $item->id }}">
                ...
                <td style="white-space:nowrap">                  
                  <a href="{{ route( 'tinh.edit', [ 'id' => $item->id ]) }}" class="btn btn-warning btn-sm"><span class="glyphicon glyphicon-pencil"></span></a>                 
                  
                  <a onclick="return callDelete('{{ $item->name }}','{{ route( 'tinh.destroy', [ 'id' => $item->id ]) }}');" class="btn btn-danger btn-sm"><span class="glyphicon glyphicon-trash"></span></a>
