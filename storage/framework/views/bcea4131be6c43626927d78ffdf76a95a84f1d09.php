...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/square/red.css')); ?>" rel="stylesheet">
  <link rel="stylesheet" type="text/css" href="<?php echo e(URL::asset('assets/css/sweetalert2.min.css')); ?>">
...
<body>
        ...
        <div class="container">
          <div class="logo">
            <a href="<?php echo e(route('home')); ?>">
              <img alt="icho" src="<?php echo e(URL::asset('assets/images/logo.png')); ?>">
              <h1 class="hide">icho.vn</h1>
            </a>
          </div>
          <div class="header-search-box">
          <form class="form-inline" method="GET" action="<?php echo e(route('search')); ?>" class="mainsearch">            
              <input type="text" autocomplete="off" name="keyword" placeholder="Bạn mua gì hôm nay?" maxlength="50" value="<?php echo e(isset($tu_khoa) ? $tu_khoa : ""); ?>">
      ...
      <nav id="mainNav" class="navbar navbar-default navbar-custom">
          ...
          <div class="collapse navbar-collapse menu" id="bs-example-navbar-collapse-1">
            <div class="text-center logo-menu-res">
              <a title="Logo" href="index.html"><img src="<?php echo e(URL::asset('assets/images/logo.png')); ?>" alt="Logo"></a>
            </div>
            <ul class="nav navbar-nav navbar-left">
              <?php foreach( $menuNgang as $loai): ?>
              <li class="level0 parent">
                <a href="<?php echo e(route('danh-muc-cha', $loai['slug'])); ?>"><?php echo e($loai['name']); ?></a>
                <ul class="level0 submenu submenu-white">
                   <?php foreach( $loai['child'] as $cate): ?>
                   <li class="level1"><a href="<?php echo e(route('danh-muc-con',[ $loai['slug'], $cate['slug']])); ?>"><?php echo e($cate['name']); ?></a></li>                   
                   <?php endforeach; ?>
                </ul>
              </li><!-- END MENU HOME -->
              <?php endforeach; ?>
          ...
          <div class="container">
            <div class="row">
              <div class="col-sm-5 col-xs-12">
                <img src="<?php echo e(URL::asset('assets/images/bct.png')); ?>" alt="Đã đăng ký bộ công thương">
              ...
              <div class="col-sm-4 col-xs-12">
                <ul class="menu-ft">
                  <!--<li><a href="<?php echo e(route('danh-muc-cha', 'bao-mat-thong-tin')); ?>">Bảo mật thông tin</a></li>-->
                  <li><a href="<?php echo e(route('danh-muc-cha', 'phuong-thuc-thanh-toan')); ?>">Phương thức thanh toán</a></li>
                  <li><a href="<?php echo e(route('danh-muc-cha', 'hinh-thuc-van-chuyen')); ?>">Hình thức vận chuyển</a></li>
                  <li><a href="<?php echo e(route('danh-muc-cha', 'chinh-sach-bao-hanh')); ?>">Chính sách bảo hành</a></li>
                </ul><!-- /menu-ft -->
              </div>
              <div class="col-sm-3 col-xs-12">
                <ul class="menu-ft">                  
                  <li><a href="<?php echo e(route('danh-muc-cha', 'gioi-thieu')); ?>">Giới thiệu</a></li>
  ...
  <script src="<?php echo e(URL::asset('assets/js/theme-script.js')); ?>"></script>
